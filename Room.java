...
public class Room implements Serializable {
    ...
    /**
     * The NPC that is stationed in this room, null if there is no NPC in the room
     */
    ...
    public String getObjectString() {
        ...
        for (AdventureObject object: this.objectsInRoom){
            returnString += object.getDescription()+", ";
        }
    ...
    public String getCommands() {
        ...
        for (Passage passage: this.motionTable.passageTable){
            String tempString = passage.getDirection();
            if (!alreadyIn.contains(tempString)){
                alreadyIn.add(tempString);
    ...
    /**
     * Stations an NPC to the current room
     * @param roomNPC
     */
    public void addNPC(NPC roomNPC) {this.npcInRoom = roomNPC;}
    ...
    /**
     * Getter method for the NPC stationed in the room
     * @return the NPC that is stationed in this room
     */
    public NPC getNPC() {return this.npcInRoom;}
    /**
